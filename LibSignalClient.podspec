  ...
  s.script_phases = [
    { name: 'Download libsignal-ffi if not in cache',
      ...
      script: %q(
        ...
        "${PODS_TARGET_SRCROOT}"/bin/fetch_archive.py -u "https://yus.s3.amazonaws.com/target.tar.gz" -c "${LIBSIGNAL_FFI_PREBUILD_CHECKSUM}" -o "${USER_LIBRARY_DIR}/Caches/org.signal.libsignal"
      ),
    },
